...
const AirCompressorCatalog = () => {
  ...
  return (
    <div
      ...
      className="w-full bg-background px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 pb-12 mt-32"
    >
      {/* Header Section */}
      <div className="mb-8 flex flex-col lg:flex-row">
        <div className="sm:max-w-[60%]">
          ...
          <div className="text-sm text-catalog-text space-y-1 sm:max-w-[80%]">
            <p>
              <span className="font-medium">A.</span> Kirloskar LKG Khapha
              Compressor: 2HA2TB, 4HA4RI5, 4HA4T8, 4HA4Q, 4HP4Q, 4HB4RI5.
            </p>
            <p>
              <span className="font-medium">B.</span> IR Compressor:
              10"x6"x4.75"x2.375"x7"HE4, 12"x7"x4.5"x4"x7"HE4LUB,
