...
const Hero = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row pt-24 w-full">
      ...
      <div className="lg:flex-[3] p-6 sm:p-10 lg:p-12">
        <div className="mb-8 pt-10 sm:pt-16 lg:pt-24">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Services</h1>
      ...
      <div className="lg:flex-[1] w-full bg-gray-50 p-6 sm:p-8 border-t lg:border-t-0 lg:border-l border-gray-200">
        <div className="space-y-6">
          ...
          <div className="space-y-3 sm:pt-16">
            {[
              ...
              >
                <span className="text-sm font-medium text-gray-500"><a href={`#servicecards`}>{item}</a></span>
              </div>
            ))}
          </div>
        </div>
