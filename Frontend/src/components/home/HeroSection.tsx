    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <style jsx>{`
        @keyframes blob1-path {
          0% { top: 10%; left: 25%; transform: scale(1) rotate(0deg); }
          25% { top: 5%; left: 35%; transform: scale(1.1) rotate(90deg); }
          50% { top: 15%; left: 45%; transform: scale(0.9) rotate(180deg); }
          75% { top: 20%; left: 30%; transform: scale(1.05) rotate(270deg); }
          100% { top: 10%; left: 25%; transform: scale(1) rotate(360deg); }
        }

        @keyframes blob2-path {
          0% { top: 30%; left: 35%; transform: scale(1) rotate(0deg); }
          25% { top: 35%; left: 55%; transform: scale(1.15) rotate(45deg); }
          50% { top: 25%; left: 65%; transform: scale(0.85) rotate(90deg); }
          75% { top: 40%; left: 50%; transform: scale(1.1) rotate(180deg); }
          100% { top: 30%; left: 35%; transform: scale(1) rotate(360deg); }
        }

        @keyframes blob3-path {
          0% { top: 30%; right: 60%; transform: scale(1) rotate(0deg); }
          25% { top: 25%; right: 15%; transform: scale(0.9) rotate(120deg); }
          50% { top: 35%; right: 5%; transform: scale(1.2) rotate(240deg); }
          75% { top: 40%; right: 15%; transform: scale(0.95) rotate(300deg); }
          100% { top: 30%; right: 60%; transform: scale(1) rotate(360deg); }
        }

        @keyframes blob4-path {
          0% { top: 10%; left: 5%; transform: scale(1) rotate(0deg); }
          25% { top: 40%; left: 45%; transform: scale(1.1) rotate(60deg); }
          50% { top: 35%; left: 35%; transform: scale(0.9) rotate(120deg); }
          75% { top: 40%; left: 50%; transform: scale(1.05) rotate(240deg); }
          100% { top: 10%; left: 5%; transform: scale(1) rotate(360deg); }
        }

        .blob1 { animation: blob1-path 8s ease-in-out infinite; }
        .blob2 { animation: blob2-path 10s ease-in-out infinite 2s; }
        .blob3 { animation: blob3-path 12s ease-in-out infinite 1s; }
        .blob4 { animation: blob4-path 9s ease-in-out infinite 3s; }
      `}</style>
