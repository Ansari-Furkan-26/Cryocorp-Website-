...
const Disclaimer = () => {
  return (
    ...
    {/* Heading */}
    <div className="flex flex-col mb-10 lg:flex-row items-center gap-8 pt-32 px-4 ml-40 lg:px-8 max-w-6xl mx-auto h-screen lg:h-auto">
    {/* Separator */}
    <div className="hidden lg:block w-px min-h-[150px] bg-gray-800 flex-shrink-0 "></div>
      ...
      <div className="space-y-5 text-sm leading-relaxed">
        ...
        <p>
          ...
          <br />
          <a href="mailto:crm@cryocorp.in" className="text-sky-600 underline inline-block mt-1">
            📧 crm@cryocorp.in
          </a>
        </p>
      </div>
